...
class Order extends connectDatabase
{
    ...
    {
        $sql="select products.ProductId,introduce,picture,Soluong,TongTien  from products inner join tableorder on products.ProductId =tableorder.ProductId where OrderTime is null and Users='$CustomerName' ";
...
class checkOutClass extends connectDatabase
{
    ...
    {
        $sql="insert into tableorderdetails values(now(),$ProductId,'$Users',$Soluong,$TongTien)";
        $this->Connection()->query($sql);
    }
    ...
    {
        $sql="select *from tableorderdetails inner join products on tableorderdetails.ProductId=products.ProductId where OrderTime='$OrderTime'";
        return $this->Connection()->query($sql);
    ...
    {
        $sql="select sum(TongTien) as total from tableorderdetails where OrderTime='$time'";
        return $this->Connection()->query($sql);
